...
output "aws_s3_yogesh_s_24_bucket_name" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_name
  sensitive = false
}


output "aws_s3_yogesh_s_24_bucket_website_endpoint" {
...
output "aws_lambda_yogesh_s_function_arn" {
